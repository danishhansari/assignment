...
const AchievementWidget = () => {
  return (
    <>
      <div className="absolute top-12 -left-12 md:-left-16 md:top-36 max-w-[190px] w-2/3 md:w-full bg-white rounded-3xl p-2 md:p-6 py-6 md:py-8 shadow-lg hidden md:block animate">
        <img
          src={spark}
